...
os.chdir("C:/Users/Admin/sciebo/Uni/Master/Masterarbeit/Fragebogen/Itemselektion/Screening_Listen")

# Import data from excel file
data_1 = pd.read_excel("item_screening_Björn.xlsx", sheet_name="Sheet1")
data_2 = pd.read_excel("item_screening_Luisa.xlsx", sheet_name="Sheet1")
data_3 = pd.read_excel("item_screening_SB.xlsx", sheet_name="Sheet1")
